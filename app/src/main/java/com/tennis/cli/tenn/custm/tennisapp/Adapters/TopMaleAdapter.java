package com.tennis.cli.tenn.custm.tennisapp.Adapters;
...
import com.tennis.cli.tenn.custm.tennisapp.Models.StatisModels.TopTwnModels;
...
public class TopMaleAdapter extends ListAdapter<PlayersModel,TopMaleAdapter.MaleViewHolder> {
    ...
    public interface OnItemClickListener{
        ...
        void onPlayerNameIsClicked(PlayersModel playersModel);
    }
            ...
            nameTxt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (onItemClickListener != null &&  p != RecyclerView.NO_POSITION){
                        ...
                        onItemClickListener.onPlayerNameIsClicked(getItem(p));
                    }
                }
            });
...
//        LocalDate birthDate = LocalDate.of(year,month,day);
        ...
        System.out.println("CALENDER YEAR IS: " + yearCal);
