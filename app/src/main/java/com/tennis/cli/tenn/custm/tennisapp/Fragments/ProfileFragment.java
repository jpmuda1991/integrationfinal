...
import com.tennis.cli.tenn.custm.tennisapp.Application.TennisCommon;
...
import com.tennis.cli.tenn.custm.tennisapp.RetrofitUtils.Api;
        ...
        backImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (MainActivity.getNavController() != null && MainActivity.getNavController().getCurrentDestination().getId() == R.id.profileFragment){
                    ...
                    }else if (from.contentEquals("MD")){

                        MainActivity.getNavController().navigate(R.id.action_profileFragment_to_matchDetailFragment);
